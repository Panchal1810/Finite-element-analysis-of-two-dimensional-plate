...
CCORD4=xlsread('plate_re8_4.xlsx',1,'A1:D22'); %Node number and corresponding cordinates are loaded
NCA4=xlsread('plate_re8_4.xlsx',1,'G1:O5');   % Element number and connected nodes with the elemnts are loaded

NCA4B = xlsread('plate_re8_4.xlsx',1,'A26:I27');
NCA4R = xlsread('plate_re8_4.xlsx',1,'A28:I29');
NCA4T = xlsread('plate_re8_4.xlsx',1,'A30:I31');
NCA4L = xlsread('plate_re8_4.xlsx',1,'A32:I33');
...
isol= [3:1:14, 19:1:30, 35:1:42]; % Free degrees of freedom
constrain = [1 2 15 16 17 18 31 32 33 34]; % constrain degree of freedom
alldof = 1:1:42; %all dof
...
for EN=1:NELEMENTS
 %EN = 1;
  %  [B]=BCAL_beam(l,EN);
   ...
   [ ke, r_qe] = Kel_plate_re8(E,v,p,q,h,CCORD,n1); % contain kk and kp, r_q
...
[ke_a , r_beta] = k_boundary_re8(side,alpha,beta,h,CCORD,n1); % contain ka and rbeta
